...
- **World Cup mode** at [`/events/world-cup`](https://tryheckle.xyz/events/world-cup) — the **real 2026 World Cup knockouts**, live from [football-data.org](https://football-data.org), with The Pundit's pre-kickoff calls settled on-chain against the actual results via **`HeckleResolver`**
